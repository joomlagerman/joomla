...
(602, 605, 'German (DE)', 'language', 'de-DE', '', 0, 1, 1, '{"name":"German (Germany)","type":"language","creationDate":"2022-08-16","author":"J!German","copyright":"Copyright (C) 2005 - 2022 Open Source Matters & J!German. All rights reserved.","authorEmail":"team@jgerman.de","authorUrl":"http:\/\/www.jgerman.de","version":"4.2.0.1","group":""}' ,'' ,''),
(603, 605, 'German (DE)', 'language', 'de-DE', '', 1, 1, 1, '{"name":"German (Germany)","type":"language","creationDate":"2022-08-16","author":"J!German","copyright":"Copyright (C) 2005 - 2022 Open Source Matters & J!German. All rights reserved.","authorEmail":"team@jgerman.de","authorUrl":"http:\/\/www.jgerman.de","version":"4.2.0.1","group":""}' ,'' ,''),
(604, 605, 'German (DE)', 'language', 'de-DE', '', 3, 1, 1, '{"name":"German (Germany)","type":"language","creationDate":"2022-08-16","author":"J!German","copyright":"Copyright (C) 2005 - 2022 Open Source Matters & J!German. All rights reserved.","authorEmail":"team@jgerman.de","authorUrl":"http:\/\/www.jgerman.de","version":"4.2.0.1","group":""}' ,'' ,''),
(605, 0, 'German (Germany) Language Pack', 'package', 'pkg_de-DE', '', 0, 1, 1, '{"name":"German (Germany) Language Pack","type":"package","creationDate":"2022-08-16","author":"J!German","copyright":"","authorEmail":"team@jgerman.de","authorUrl":"http:\/\/www.jgerman.de","version":"4.2.0.1","group":"","filename":"pkg_de-DE"}' ,'' ,'');
...
UPDATE IGNORE `#__modules` SET `title` = 'Login Support' WHERE `id` = 90;
UPDATE IGNORE `#__modules` SET `title` = 'System Dashboard' WHERE `id` = 91;
UPDATE IGNORE `#__modules` SET `title` = 'Content Dashboard' WHERE `id` = 92;
UPDATE IGNORE `#__modules` SET `title` = 'Menus Dashboard' WHERE `id` = 93;
UPDATE IGNORE `#__modules` SET `title` = 'Components Dashboard' WHERE `id` = 94;
UPDATE IGNORE `#__modules` SET `title` = 'Users Dashboard' WHERE `id` = 95;
UPDATE IGNORE `#__modules` SET `title` = 'Popular Articles' WHERE `id` = 96;
UPDATE IGNORE `#__modules` SET `title` = 'Recently Added Articles' WHERE `id` = 97;
UPDATE IGNORE `#__modules` SET `title` = 'Logged-in Users' WHERE `id` = 98;
UPDATE IGNORE `#__modules` SET `title` = 'Frontend Link' WHERE `id` = 99;
UPDATE IGNORE `#__modules` SET `title` = 'Messages' WHERE `id` = 100;
UPDATE IGNORE `#__modules` SET `title` = 'Post Install Messages' WHERE `id` = 101;
UPDATE IGNORE `#__modules` SET `title` = 'User Status' WHERE `id` = 102;
...
UPDATE IGNORE `#__modules` SET `title` = 'Help Dashboard' WHERE `id` = 106;
UPDATE IGNORE `#__modules` SET `title` = 'Privacy Requests' WHERE `id` = 107;
UPDATE IGNORE `#__modules` SET `title` = 'Privacy Status' WHERE `id` = 108;
